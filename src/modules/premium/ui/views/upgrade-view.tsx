...
export const UpgradeViewLoading = () =>{
    return (
        <LoadingState title="Loading Upgrade View..."  description="This may take a few seconds." />
    )
}
 
export const UpgradeViewError = () =>{
    return (
        <ErrorState title="Error Loading Upgrade View"  description="There was an error loading the upgrade view. Please try again later." />
    )
}